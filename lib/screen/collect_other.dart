...
class CollectOtherPage extends StatefulWidget {
  @override
  State<CollectOtherPage> createState() => _CollectOtherPageState();
}

class _CollectOtherPageState extends State<CollectOtherPage> {
  //藥品
